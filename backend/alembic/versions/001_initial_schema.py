...
def upgrade() -> None:
    ...
    op.create_index('ix_band_dept_level_country', 'salary_bands', ['department', 'job_level', 'country'], unique=True)
    ...
    op.create_index('ix_emp_dept_country_level', 'employees', ['department', 'country', 'job_level'], unique=False)
    ...
    op.create_index('ix_salary_emp_current', 'salary_records', ['employee_id', 'is_current'], unique=False)
    op.create_index(op.f('ix_salary_records_base_salary_usd'), 'salary_records', ['base_salary_usd'], unique=False)
    op.create_index(op.f('ix_salary_records_total_compensation_usd'), 'salary_records', ['total_compensation_usd'], unique=False)
    ...
    op.create_index('ix_audit_emp_created', 'salary_audit_logs', ['employee_id', 'created_at'], unique=False)
